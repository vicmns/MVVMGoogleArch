 ...
 */
class SourcesListItemAnimator : SourceCommonItemAnimator<SourcesListAdapter.SourcesListViewHolder>() {


    override fun animateAddSource(holder: SourcesListAdapter.SourcesListViewHolder) {
    ...
    override fun animateRemoveSource(holder: SourcesListAdapter.SourcesListViewHolder) {
        val animatorSet = AnimatorSet()
